        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 pb-0 text-gray-900 dark:text-gray-100">
                    <section class="bg-gray-100 dark:text-gray-400 dark:bg-gray-900 body-font overflow-hidden">
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <section class="bg-gray-100 dark:text-gray-400 dark:bg-gray-900 body-font overflow-hidden">
                        <div class="container px-5 py-6 mx-auto">
                            <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 dark:text-white">
                                今月の総学習時間：
                    ...
                    <section class="bg-gray-100 dark:text-gray-400 dark:bg-gray-900 body-font overflow-hidden">
                        <div class="container px-5 py-6 mx-auto">
                            <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 dark:text-white">今日の学習記録</h1>
